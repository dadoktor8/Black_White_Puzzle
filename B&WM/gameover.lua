...
function scene:create( event )
    ...
    levelValueText = display.newText( uiGroup, " ", display.contentCenterX + 200, display.contentCenterY - 100,"neuropolitical_rg.tff",30)
    levelValueText:setFillColor(1,1,1)
    menuButtonText = display.newText( uiGroup, "START MENU", display.contentCenterX - 200,display.contentCenterY - 100,"neuropolitical_rg.tff",30)
...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        levelValue = composer.getVariable( "level" )
        levelValueText.text = "You went till level: " .. levelValue
